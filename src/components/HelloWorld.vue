<template lang="pug">
  ...
  body(oncontextmenu="return false")
    span(@click="nuevoJuego()") Juego Nuevo
    span.minas 000
    span.Ajustes(@click="ajustes()")
      i.fas.fa-cog
    table.tablero
</template>
...
export default {
  props:{
    sounds:{
      sonido_ganador: new Audio("sonido_ganador.ogg"),
      sonido_win: new Audio("sonido_win.ogg"),
      sonido_perdedor: new Audio("sonido_perdedor.ogg"),
      sonido_gameover = new Audio("sonido_gameover.ogg"),
      sonido_descubrir = new Audio("sonido_descubrir.ogg"),
      sonido_juegonuevo = new Audio("sonido_nuevojuego.ogg"),
      sonido_abrirarea = new Audio("sonido_abrirarea.ogg"),
      sonido_marca = new Audio("sonido_marca.ogg"),
  },
  data () {
    return {
     filas: 20,
  ...
  computed:{
    percentage () {
    return Math.round(( this.totalAvailable * 100 ) / this.population.length) + "%";
    }
  },
  methods:{
    nuevoJuego () {
